...
export default function PreviewSection() {
  ...
  const cardBase = "relative rounded-2xl overflow-hidden border border-black/10 bg-white/55 backdrop-blur-md shadow-[0_14px_50px_rgba(0,0,0,0.14)]";
  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        style={{
          background:
            "linear-gradient(135deg, #fff6ec 0%, #f1f6ff 52%, #f4fff8 100%)",
      ...
      >
        ...
        >
          ...
          >
            ...
            {/* ✅ Card “Titolo” per riempire lo spazio sotto la featured */}
            <motion.article
              style={{ y: yTitle }}
              initial={{ opacity: 0, y: 18 }}
              whileInView={{ opacity: 1, y: 0 }}
              ...
              >
                ...
                >
                  ...
                  >
                    ...
                    (Placeholder) Qui possiamo inserire una breve frase curatoriale o un micro–indice
                    per dare contesto alla selezione.
