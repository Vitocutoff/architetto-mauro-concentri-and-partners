...
export default function PreviewHighlightCard({
  y,
  fontSans,
  fontSerif,
    ...
    >
      ...
      <div className="relative p-6 sm:p-7 flex flex-col gap-5">
        <div className="flex items-center gap-3">
          ...
          <div className={`${fontSans} text-xs tracking-[0.18em] uppercase text-black/55`}>
            in primo piano
          </div>
        </div>

        <div>
          <div className={`${fontSerif} text-2xl text-black/85`}>Brendola</div>

          <div className={`${fontSans} mt-2 text-sm leading-relaxed text-black/60`}>
        ...
        >
          <div className="flex items-center gap-5">
            ...
            <div className="flex-1">
              <div className={`${fontSans} font-semibold tracking-wide text-white/92`}>
                Guarda il video
              </div>

              <div className={`${fontSans} mt-1 text-sm text-white/60`}>
                Video cantiere
              </div>
            </div>
          </div>
        ...
        <div className="flex items-center justify-between">
          ...
          <a
            href="/progetti"
            className={`${fontSans} ml-4 text-xs tracking-[0.18em] uppercase
