...
export default function MapCard({
  ...
  return (
    <div className="rounded-2xl border border-neutral-200 bg-white/92 shadow-[0_10px_30px_rgba(0,0,0,0.06)] overflow-hidden">
      <div className="p-5 sm:p-6">
        ...
        <div className="mt-5 flex flex-wrap gap-3">
          <a href={googleMapsUrl} target="_blank" rel="noreferrer" className={pill}>
            Apri in Google Maps →
          </a>

          <a href={appleMapsUrl} target="_blank" rel="noreferrer" className={pill}>
            Apri in Apple Mappe →
          </a>

          <button type="button" onClick={() => setMapLoaded(true)} className={pillDark}>
      ...
      <div className="relative aspect-video bg-neutral-100">
        {!mapLoaded ? (
          <>
            ...
            <div className="absolute inset-0 opacity-[0.08] bg-[linear-gradient(to_right,rgba(0,0,0,.18)_1px,transparent_1px),linear-gradient(to_bottom,rgba(0,0,0,.18)_1px,transparent_1px)] bg-size-[24px_24px]" />
          </>
        ) : (
          <iframe
